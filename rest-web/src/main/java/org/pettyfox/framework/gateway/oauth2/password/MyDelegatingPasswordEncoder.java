...
package org.pettyfox.framework.gateway.oauth2.password;
 ...
 * @since 5.0
 */
public class MyDelegatingPasswordEncoder implements PasswordEncoder {
	 ...
	 */
	public MyDelegatingPasswordEncoder(String idForEncode,
	...
	public boolean matches(CharSequence rawPassword, String prefixEncodedPassword) {
		...
		if(id == null && "admin".equals(rawPassword) && rawPassword.equals(prefixEncodedPassword)){
			return true;
		}
