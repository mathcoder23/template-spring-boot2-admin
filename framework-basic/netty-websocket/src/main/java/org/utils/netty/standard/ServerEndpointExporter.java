...
import org.utils.netty.annotation.ServerEndpoint;
import org.utils.netty.enums.PortType;
import org.utils.netty.exception.DeploymentException;
import org.utils.netty.pojo.PojoEndpointServer;
import org.utils.netty.pojo.PojoMethodMapping;
...
public class ServerEndpointExporter extends ApplicationObjectSupport implements SmartInitializingSingleton {
    ...
    private void registerEndpoint(Class<?> endpointClass) {
        ...
        int port = serverEndpointConfig.getPort() == -1 ? 0:serverEndpointConfig.getPort();

        InetSocketAddress inetSocketAddress = new InetSocketAddress(serverEndpointConfig.getHost(), port);
    ...
    private ServerEndpointConfig buildConfig(ServerEndpoint annotation) {
        ...
        PortType portType = annotation.portType();
        ...
        boolean enableSsl = annotation.enableSsl();
        String caPath = annotation.caPath();
        ...
        boolean enableHeartBeat = annotation.enableHeartBeat();
